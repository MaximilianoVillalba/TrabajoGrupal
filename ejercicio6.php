        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking_lanin2.jpg" alt="">
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking_lanin1.jpg" alt="">
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking_tromen1.jpg" alt="">
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking_tromen2.jpg" alt="">
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking_mendoza1.jpg" alt="">
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking_lanin1.jpg" alt="">
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking_ushuaia1.jpg" alt="">
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking_ushuaia2.jpg" alt="">
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking5.jpeg" alt="">
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 img-container centrado">
                    <img class="img-lista img-fluid" src="./img/trekking6.jpg" alt="">
                </div>
            </div>
        </div>
